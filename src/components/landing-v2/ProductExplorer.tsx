...
const PRODUCTS = [
  {
    ...
    tagline: "SMS-kuponger som loses in i butik.",
    color: "var(--clr-coral)", colorSoft: "var(--clr-coral-soft)", icon: "\u25CE",
    forLabels: ["Marknad", "FMCG"],
    bullets: ["Skicka kampanj pa minuter", "Inlosen i 5 000+ butiker", "Automatisk clearing"],
    metric: { v: "3-5x", l: "hogre inlosen vs print" },
  },
  {
    id: "mobila-presentkort", name: "Mobila presentkort",
    tagline: "Vardet i fickan, inget kort att tappa bort.",
    ...
    metric: { v: "<60 s", l: "fran skickat till mottaget" },
  },
  {
    ...
    metric: { v: "5 000+", l: "inlosenstallen" },
  },
  {
    ...
    forLabels: ["Drift"],
    bullets: ["SMS med vardebarare", "Fran klagomal till lost", "Full sparbarhet"],
    metric: { v: "+38p", l: "NPS-lyft i snitt" },
  },
  {
    id: "personalbeloning", name: "Personalbeloning",
    tagline: "Tack for insatsen, pa sekunder.",
    color: "var(--clr-lilac)", colorSoft: "#ebe3f5", icon: "\u2661",
    forLabels: ["HR"],
    bullets: ["Vardecheckar i batch", "Skatteklassificering klar", "Export till lon"],
  ...
  },
  {
    ...
    forLabels: ["Marknad", "FMCG"],
    bullets: ["Egna kampanjsidor", "A/B-test av erbjudande", "Integrerad matning"],
    metric: { v: "2x", l: "konverteringsgrad" },
  },
  {
    id: "send-a-gift", name: "Send a gift",
    tagline: "Ge bort ett urval av Sveriges basta varumarken.",
    color: "#ffd6a8", colorSoft: "#fff3e1", icon: "\u2756",
    forLabels: ["HR", "Drift"],
    bullets: ["Mottagaren valjer", "Smakfull presentation", "Alltid aktuellt sortiment"],
    metric: { v: "4,7/5", l: "mottagarnojdhet" },
  },
  {
    id: "clearing", name: "Clearing Solutions",
    tagline: "Clearing-infra for hela kedjan.",
    color: "var(--clr-navy-soft)", colorSoft: "#e6ebf5", icon: "\u25A4",
    forLabels: ["CFO", "VD"],
    bullets: ["Anslut kedjan pa dagar", "Saker och auditerbar", "Alla vardebarare i ett flode"],
    metric: { v: "99,8%", l: "tillforlitlighet" },
  },
];

const filters = [
  { id: "alla", label: "Alla produkter" },
  { id: "marknad", label: "Marknad & Salj" },
  { id: "hr", label: "HR & Personal" },
  { id: "drift", label: "Kundtjanst" },
  { id: "fmcg", label: "FMCG" },
  { id: "cfo", label: "CFO" },
];
      ...
      <div className="c-container">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "end", marginBottom: 40, flexWrap: "wrap", gap: 20 }}>
          <div>
            ...
            <h2 className="c-h2" style={{ maxWidth: 680 }}>En plattform,<br/>atta tjanster.</h2>
          </div>
          <p className="c-body" style={{ maxWidth: 360 }}>
            Filtrera efter roll for att se vad som passar just dig. Klicka for att lasa mer.
          </p>
        </div>
              ...
              <div style={{ padding: 28, cursor: "pointer" }} onClick={() => {
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12, fontSize: 14 }}>
                  <span style={{ color: "var(--clr-green-dark)", fontWeight: 600, display: "inline-flex", alignItems: "center", gap: 6 }}>
                    {expanded === p.id ? "Visa mindre" : "Las mer"}
              ...
              {expanded === p.id && (
                <div style={{ padding: "0 28px 28px" }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
                    ...
                    <div>
                      <div className="c-eyebrow" style={{ marginBottom: 10 }}>Passar bast for</div>
